...
const HeroSection = () => {
  return (
    <section className="pt-16">
        ...
        titleComponent={
          <>
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              <div className="flex flex-wrap justify-center gap-4 animate-fade-in mt-8" style={{ animationDelay: "0.4s" }}>
              ...
              <div className="bg-amber-100 border border-amber-200 rounded-md p-3 text-amber-800 text-sm flex items-center gap-2 animate-fade-in max-w-xl mx-auto" style={{ animationDelay: "0.5s" }}>
      ...
      <div className="container mx-auto px-4 -mt-40 md:-mt-32">
        <div className="flex items-center space-x-2 animate-fade-in justify-center" style={{ animationDelay: "0.6s" }}>
        ...
        <div className="flex items-center space-x-4 animate-fade-in justify-center mt-4" style={{ animationDelay: "0.7s" }}>
