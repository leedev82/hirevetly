      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-2">
            <h2 className="text-2xl font-bold mb-4">TalentMatch</h2>
            <p className="text-gray-400 mb-4 max-w-md">
              Revolutionizing recruitment with AI-powered candidate matching, streamlined interviews, and data-driven hiring decisions.
            </p>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center space-x-4">
              <img src="/placeholder.svg" alt="GDPR Compliant" className="h-10" />
              <img src="/placeholder.svg" alt="SOC 2" className="h-10" />
              <img src="/placeholder.svg" alt="SSL Secure" className="h-10" />
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 text-sm text-gray-400">
            ...
            <span>&copy; 2025 TalentMatch. All rights reserved.</span>
          </div>
        </div>
      </div>
    </footer>
